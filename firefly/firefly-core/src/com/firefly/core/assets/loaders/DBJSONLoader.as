...
package com.firefly.core.assets.loaders
{
	...
	/** The loader for loading particle json asset. */
	[ExcludeClass]
	public class DBJSONLoader extends JSONLoader
	{
		/** @private */		
		...
		public function DBJSONLoader(id:String, path:String, autoScale:Boolean = true)
		{
		...
		/** @private */
		override protected function onJSONLoadingComplete(event:Event):void
		{
			super.onJSONLoadingComplete(event);
			
			_dbData = DataParser.parseData(JSON.parse(json));
