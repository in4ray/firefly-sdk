...
package com.firefly.core.utils
{
	...
	public class TextureUtil
	{
		 ...
		 *  @param adjustTextureName DragonBons Pro tool adds <code>"parts/"</code> string for each texture
		 * 		   name in the begining of the name for skeleton JSON/XML file during exporting. In case you use texture 
		 * 		   atlas xml generated by yourself you will have some problems with naming in your xml and skeleton json.</br></br>
		 * 		   By default this function removes this part of the string. Set this parameter to <code>false</code> to ignore adjusting.
		 *  @return Returns adjusted skeleton data.  */
		public static function adjustDragonBonesData(data:DragonBonesData, adjustTextureName:Boolean=true):DragonBonesData
		{
			...
			for each (var armatureData:ArmatureData in  data.armatureDataList)
			{
				...
				{
					for each (var timeline:* in animationData.timelineList)
					{
