package
{
	...
	[SWF (frameRate="60"]
	public class LandscapeGameTemplate2 extends GameApplication
	{
		// Comfortaa
		...
		public function LandscapeGameTemplate2()
		{
			super();
			...
			analytics = new GoogleAnalytics("Landscape Game Template 2", AppConsts.GA_TRACKER_ID);
