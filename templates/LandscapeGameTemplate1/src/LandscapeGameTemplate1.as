package
{
	...
	public class LandscapeGameTemplate1 extends GameApplication
	{
		...
		public function LandscapeGameTemplate1()
		{
			...
			analytics = new GoogleAnalytics("Landscape Game Template 1", AppConsts.GA_TRACKER_ID);
