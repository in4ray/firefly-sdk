package
{
	...
	public class PortraitGameTemplate4 extends GameApplication
	{
		...
		public function PortraitGameTemplate4()
		{
			...
			analytics = new GoogleAnalytics("Portrait Game Template 4", AppConsts.GA_TRACKER_ID);
