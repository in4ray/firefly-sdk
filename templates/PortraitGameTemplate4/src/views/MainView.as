package views
{
	...
	public class MainView extends Sprite
	{
		...
		public function MainView()
		{
			...
			navigator.addView(BundlesView, ViewStates.BUNDLES, menuTextureState);
			...
			navigator.addTransition(new LoadingTransition(ViewStateEvent.SWITCH_TO_STATE, ViewStates.MENU, ViewStates.BUNDLES, blackState));
			
			// bundles transition
			navigator.addTransition(new LoadingTransition(ViewStateEvent.SWITCH_TO_STATE, ViewStates.BUNDLES, ViewStates.MENU, blackState));
			navigator.addTransition(new LoadingTransition(ViewStateEvent.SWITCH_TO_STATE, ViewStates.BUNDLES, ViewStates.LEVELS, blackState));
			
			// levels transition
			navigator.addTransition(new LoadingTransition(ViewStateEvent.SWITCH_TO_STATE, ViewStates.LEVELS, ViewStates.BUNDLES, blackState));
			...
			navigator.addTransition(new LoadingTransition(ViewStateEvent.BACK, ViewStates.LEVELS, ViewStates.BUNDLES, blackState));
			navigator.addTransition(new LoadingTransition(ViewStateEvent.BACK, ViewStates.BUNDLES, ViewStates.MENU, blackState));
