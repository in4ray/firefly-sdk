package
{
	...
	public class PortraitGameTemplate2 extends GameApplication
	{
		...
		public function PortraitGameTemplate2()
		{
			...
			analytics = new GoogleAnalytics("Portrait Game Template 2", AppConsts.GA_TRACKER_ID);
