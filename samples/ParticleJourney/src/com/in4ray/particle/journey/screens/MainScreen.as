package com.in4ray.particle.journey.screens
{
	...
	public class MainScreen extends ScreenNavigator
	{
		public function MainScreen()
		{
			...
			controller.regScreen(GameState.MENU, new CacheableClassFactory(MenuScreen), "menu");
			controller.regScreen(GameState.GAME, new CacheableClassFactory(GameScreen), "game");
